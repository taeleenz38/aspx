...
const Navbar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 pt-4 pb-32 pl-4 z-20 flex justify-between text-primary items-center h-64 bg-gradient-to-t from-transparent via-white to-white">
