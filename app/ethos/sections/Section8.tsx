...
const Section8 = () => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-dvh md:min-h-screen text-black pt-24 md:pt-40 pb-14 flex flex-col justify-between overflow-visible"
    >
      {/* Top Heading */}
      ...
      {/* Bottom Paragraph */}
      <motion.div
        className="font-extralight self-end w-4/5 md:w-full text-lg md:text-3xl lg:text-4xl text-right"
        initial="hidden"
        animate={isInView ? "visible" : "hidden"}
