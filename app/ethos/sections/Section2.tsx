  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <h1
          ref={titleRef}
          className="italic font-normal text-3xl md:text-5xl lg:text-7xl mb-4 leading-tight whitespace-pre-wrap"
        >
          {title}
        </h1>
        <p
          ref={subtitleRef}
          className="font-extralight text-2xl md:text-3xl lg:text-5xl whitespace-pre-wrap"
        >
          {subtitle}
        </p>
      </div>
      <div className="w-full flex justify-center">
        <img
          src="/ethos-1.png"
          className="w-180 h-auto object-contain mt-4 mr-4 md:mr-28"
          alt="Ethos"
        />
      </div>
      <MotionComponent.p
        className="font-extralight text-2xl md:text-3xl lg:text-5xl text-right origin-center"
