...
const Section7 = () => {
  return (
    <div className="h-dvh md:min-h-screen text-black pt-36 pb-14 flex flex-col justify-center items-center">
      ...
      <div className="text-2xl md:text-3xl lg:text-4xl text-center w-3/4 font-extralight mt-6">
        <p>
      ...
      <div className="flex justify-center items-center font-extralight mt-14 h-auto w-full">
        <div className="flex flex-col items-center gap-y-6 w-60 md:w-120 pl-12 md:pl-32">
          <p className="text-3xl md:text-5xl lg:text-7xl">Corporation</p>
          <p className="text-3xl md:text-5xl lg:text-7xl font-normal">{">"}</p>
          <p className="text-3xl md:text-5xl lg:text-7xl">Artist</p>
        </div>
        {/* Vertical Divider */}
        <div className="w-1 bg-black h-40 md:h-90 mx-14 md:mx-24" />{" "}
        <p className="text-3xl md:text-5xl lg:text-7xl w-60 md:w-120">Artist = Partner</p>
      </div>
    </div>
  );
};
