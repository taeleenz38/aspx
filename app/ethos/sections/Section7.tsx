...
const Section7 = () => {
  return (
    <div className="h-dvh md:min-h-screen text-black pt-24 md:pt-36 pb-14 flex flex-col justify-center items-center">
      ...
      <div className="text-xl md:text-3xl lg:text-4xl text-center w-5/6 md:w-3/4 font-extralight mt-6">
        <p>
      ...
      <div className="flex justify-center items-center font-extralight mt-14 h-auto w-full">
        ...
        <p className="text-2xl md:text-5xl lg:text-7xl w-40 md:w-120">Artist = Partner</p>
      </div>
    </div>
  );
};
